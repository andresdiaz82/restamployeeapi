...
public class DependenciaDAOImpl implements DependenciaDAO {
	...
	public Dependencia consultaDependenciaId(int id) {
		// TODO Auto-generated method stub
		Dependencia dependencia = entityManager.find(Dependencia.class, id);
		return dependencia;
	}
	...
	@Override
	public void actualizaDependencia(Dependencia dependencia) {
		// TODO Auto-generated method stub
		entityManager.merge(dependencia);
	}
